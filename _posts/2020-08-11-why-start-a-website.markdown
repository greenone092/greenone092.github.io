...
I should also mention that while Wix / Squarespace / Wordpress are options for starting a webpage, I think I'm still stuck in the same cycle but one level higher. Should any of those services fail, I would have to find another one. To my knowledge, it's basically impossible to transfer the website you made to anywhere else, as such you will get stuck with them, just like you would with any form of social media. It's just not a long term solution.